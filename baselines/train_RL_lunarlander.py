...
if __name__=="__main__":
    ...
    map_names = {"gridworld": "grid_64x64_map1", "taxiworld": "taxi_30x30_map1", "officeworld": "office_36x36_map1", "waterworld": "water_"+str(gridsize[0])+"x"+str(gridsize[1])+"_map1", "lunarlander": "lunarlander"}
