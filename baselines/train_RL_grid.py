...
def create_subproc_envs(env_name, num, gridsize):
  ...
  if env_name == "gridworld":
          ...
          gamma = 0.95
          for i in range(num):
            envs.append(make_env(GridworldEnv("./gym_envs/maps/grid_"+str(gridsize[0])+"x"+str(gridsize[1])+"_map1.map",(0,0),(gridsize[0]-1,gridsize[1]-1),step_max)))
...
if __name__=="__main__":
    ...
    env_names = ["gridworld"]
    algorithms = ["dqn"] #"dqn", "a2c"
    exps = ["1","2","3","4","5"]
    num_subproc = 1
    verbose = 0
    gridsizes = [(8,8), (16,16), (32,32), (44,44), (64,64)]
    # gridsize = gridsizes[int(grid)]
    gridsize = (64,64)
    max_time = 10*60*60

    # for gridsize in gridsizes:
    map_names = {"gridworld": "grid_"+str(gridsize[0])+"x"+str(gridsize[1])+"_map1", "taxiworld": "taxi_30x30_map1", "officeworld": "office_36x36_map1"}
